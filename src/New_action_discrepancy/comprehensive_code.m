...
loaded_HDC = Load_HDC('/Users/yuang/Documents/MATLAB/IP_POLAR_LDC2HDC/HDC_POLAR.mat');
path_save_LDC = '/Users/yuang/Documents/MATLAB/New_action_discrepancy/new_multiple_LDCs/LDC_theta0-2_dot-2-0.txt';
training_data_300 = gather_training_date(loaded_HDC, state_region, sample_size);
weights_bias_LD = Train_LDC(training_data_300, path_save_LDC);
...
conformal_table_1LDC = action_based_CP(path_LDC, path_HDC, state_region, split_parameter);

function conformal_table = action_based_CP(path_LDC, path_HDC, state_region, split_parameter)
