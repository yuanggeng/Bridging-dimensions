...
*/
	...
	if(b)
	{
		...
		ofstream reach_output("./outputs_noised_traj/reach_verification/" + good_result + "_" + to_string(start_pos) + to_string(start_velocity) +".txt");
		reach_result = "Verification result: Yes(" + to_string(steps) + ")";
	}
	else
	{
	...
	ofstream result_output("./outputs_noised_traj/" + benchmark_name + "_" + to_string(if_symbo) + ".txt");
	...
	plot_setting.plot_2D_octagon_GNUPLOT("./outputs_noised_traj/", benchmark_name + "_" + to_string(if_symbo) + "_" + to_string(start_pos) + "_" + to_string(start_velocity), result.tmv_flowpipes, setting);
	...
	ofstream reach_output("./outputs_noised_traj/computation_time/" + to_string(exe_time) +".txt");
