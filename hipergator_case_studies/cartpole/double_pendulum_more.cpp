...
//			cout << "Flowpipe taylor remainder: " << initial_set.tmv.tms[0].remainder << "     " << initial_set.tmv.tms[1].remainder << endl;
		...
		else
		{
			...
			ofstream result_output("./outputs/test_overestimation/" + bad_estimation  + "_" + to_string(pos) +"_"+ to_string(vel)+"_"+ to_string(theta)+"_"+to_string(dot)+".txt");
		...
		ofstream reach_output("./outputs/reach_verification/" + good_result + "_" + to_string(pos) +"_"+ to_string(vel) +"_"+ to_string(theta) +"_"+ to_string(dot)+".txt");
	...
	plot_setting.plot_2D_octagon_GNUPLOT("./outputs/", benchmark_name + "_" + "theta" + "_" + to_string(pos) +"_"+ to_string(vel) +"_"+ to_string(theta) +"_"+ to_string(dot), result.tmv_flowpipes, setting);
	}
					}
		}
	}
